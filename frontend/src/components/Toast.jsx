const Toast = ({ message, type = 'success', onClose }) => {
    ...
    return (
        <div className={`${bgColor} text-white px-6 py-4 rounded-lg shadow-xl flex items-center space-x-3 w-full max-w-sm animate-slide-in-right transform transition-all duration-300 hover:scale-[1.02]`}>
            {icon}
